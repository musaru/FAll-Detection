...
class TwoStreamSpatialTemporalGraph(nn.Module):
    ...
    def __init__(self, graph_args, num_class, edge_importance_weighting=True,
        ...
        self.atten1 = nn.Linear(256 * 2, 64)
        self.atten_bn = nn.BatchNorm1d(64)
        self.atten_relu= nn.LeakyReLU(inplace=True)
        self.atten2 = nn.Linear(256,32)
        self.atten_relu2= nn.LeakyReLU(inplace=True)
        self.atten3 = nn.Linear(64, 256 * 2)
